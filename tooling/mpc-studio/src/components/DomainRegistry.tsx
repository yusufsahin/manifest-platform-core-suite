...
const DomainRegistry = ({ definitions }: DomainRegistryProps) => {
  return (
          ...
          {definitions.map((def, i) => (
            ...
            >
              ...
              <div className="opacity-0 group-hover:opacity-100 transition-opacity">
                <button className="text-[9px] font-bold text-violet-400 hover:text-violet-300 uppercase tracking-widest">Detail</button>
              </div>
            </div>
          ))}
